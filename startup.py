...
def getUserToken(code):
    global TOKEN_DATA
    TOKEN_DATA = getToken(code, CLIENT_ID, CLIENT_SECRET, "http://localhost:5000/callback/")
...
def getRandomPlaylists(userPlaylists, randNums):
        playlistInfo = []
        PlaylistIDs = []
        PlaylistNames = []
...
def createPlaylist(access_token, userid, username, friendname):
        ...
        description = f"{username} and {friendname}\'s Playlist"
        public = "true"
        jsonData = {}
        jsonData["name"] = name
